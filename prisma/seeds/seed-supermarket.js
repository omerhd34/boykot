...
<div style="text-align: center; margin-top: 12px;"><a href="https://x.com/hashtag/a101boykot" target="_blank" rel="noopener noreferrer" style="display: inline-block; padding: 8px 20px; background-color: #991b1b; color: white; font-weight: bold; text-decoration: none; border-radius: 6px; transition: all 0.2s ease;" onmouseover="this.style.backgroundColor='#7f1d1d'; this.style.transform='translateY(-2px)'; this.style.boxShadow='0 4px 8px rgba(0,0,0,0.2)';" onmouseout="this.style.backgroundColor='#991b1b'; this.style.transform='translateY(0)'; this.style.boxShadow='none';">KANIT</a></div>`,
    },
    {
      ...
      ctgry: "Süpermarket",
      founder:
        "Cüneyd Zapsu ve Aziz Zapsu ve Yasin El Kadı ve Korkut Özal ve Mustafa Latif Topbaş ve Mehmet Fatih Saraç",
      owner:
...
Türkiye dışında Fas ve Mısır'da da faaliyet gösteren şirketin BİMCell, Aytaç ve FİLE gibi alt markaları bulunmaktadır. BİM, tedarik zincirini optimize ederek maliyetleri düşürmekte ve bu sayede müşterilerine uygun fiyatlı ürünler sunabilmektedir. Şirket, sürdürülebilir büyüme stratejisiyle hem Türkiye'de hem de uluslararası pazarlarda varlığını güçlendirmeye devam etmektedir.`,
      boycottReason: `BİM, doğrudan boykot edilen bir marka olmamakla birlikte bazı tüketiciler tarafından çeşitli sebeplerle tercih edilmeyebilmektedir. Bu nedenle "önerilmiyor" olarak kategorize edilmiştir.

BİM yerine farklı alternatifleri değerlendirmek isteyen tüketiciler için yaygın seçenekler bulunmaktadır. Bu marketler, yerel ekonomiyi desteklemenin yanı sıra farklı ürün çeşitliliğiyle de iyi birer alternatif olabilir. Alternatif ürünlere bakınız.`,
    },
    {
      name: "Migros",
      slug: "migros",
...
2021 yılında şirket "File Market" adlı bir market teslimat uygulaması geliştirmiştir. Nisan 2021 itibarıyla şirketin Türkiye'de 135 şubesi ve yaklaşık 4.000 çalışanı bulunmaktadır.`,
      boycottReason: `File'in önerilmemesinin temel nedeni, şirketin Bim'e ait olması ve Bim'in önerilmeyen bir marka olmasıdır. File, Bim bünyesinde faaliyet göstermekte ve Bim markası altında yönetilmektedir.

Bim, doğrudan boykot edilen bir marka olmamakla birlikte bazı tüketiciler tarafından çeşitli sebeplerle tercih edilmeyebilmektedir. Bu nedenle "önerilmiyor" olarak kategorize edilmiştir.

File'in Bim'e ait olması ve Bim bünyesinde faaliyet göstermesi nedeniyle, Bim'in önerilmemesi File'i de kapsamaktadır. Bu nedenle File markası önerilmeyen markalar listesine dahil edilmiştir.`,
    },
    {
      name: "Seç Market",
      slug: "sec-market",
