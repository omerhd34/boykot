const supermarketCategory = {
 ...
 brands: [    // Happy Center ekle.
  {
   name: "Şok",
   slug: "sok-market",
   foundedYear: 1995,
   founder: "Migros",
   owner: "Halka açık (%31,47), Turkish Retail Investments B.V. (%23,53), Gözde Girişim (%22,94), Yıldız Holding (%5,46) ve Diğer (%17,06)",
   country: "Türkiye",
   ...
   description: `ŞOK Marketler Ticaret A.Ş., 1995 yılında kurulan ve 2011 yılında geçirdiği yönetim değişikliğiyle Türkiye’nin en yaygın perakende zincirlerinden biri haline gelen indirim marketidir. İstanbul merkezli şirket, 2025 yılı verilerine göre 81 ilde 10.981 mağaza ile hizmet vermekte olup, aynı zamanda "Cepte Şok" ve "Şok Net" gibi girişimlerle dijital ve internet hizmetleri sektöründe de faaliyet göstermektedir.

Mağazalarında temel gıda, temizlik malzemeleri ve teknolojik ürünlerin satışını gerçekleştiren ŞOK, hem tanınmış markaları hem de kendi öz markalı ürünlerini tüketicilere sunmaktadır. Şirket, perakende sektöründeki operasyonlarını genişletirken, yönetim ve sermaye yapısı itibarıyla Türkiye'nin büyük holdinglerinden biri olan Yıldız Holding (Ülker Grubu) çatısı altında yer almaktadır.`,
   boycottReason: `ŞOK Marketler, ortaklık yapısı itibarıyla Yıldız Holding (Ülker Grubu) bünyesindedir. Şirketin %5,46'sı doğrudan Yıldız Holding'e, %22,94'ü ise Yıldız Holding bünyesindeki Gözde Girişim'e aittir. Toplamda %28,4'lük pay ile Yıldız Holding'in kontrolündedir.

Yıldız Holding'in, Filistin meselesinde İsrail yanlısı tutum sergileyen Starbucks ile süregelen ticari ilişkisi, hassas tüketiciler tarafından eleştirilmektedir. Ülker Grubu'nun sahibi Yahya Ülker'in, toplumsal boykot sürecinde Starbucks'ı ziyaret etmesi ve ŞOK marketlerinde Starbucks ürünlerine özel raflar ayrılarak satışının sürdürülmesi, sosyal medyada büyük tepki toplamıştır.

Birçok tüketici, Filistin'deki duruma karşı sessiz kalan ve İsrail yanlısı politikaları desteklediği düşünülen Starbucks ile ticari bağları sürdüren firmaların boykot edilmesi gerektiğini savunmaktadır. Bu nedenle, Yıldız Holding çatısı altında bulunan ŞOK Marketler önerilmiyor kategorisindedir.`,
  },
  {
   name: "Bizim Toptan",
   slug: "bizim",
   foundedYear: 2001,
   founder: "Bilinmiyor",
   owner: "Yıldız Holding (%66,59) ve Halka Açık (%33,41)",
   country: "Türkiye",
   alternative_products: [
    "tarim-kredi-kooperatif-marketleri",
    "cagri",
...
Temmuz 2014'te Bizim Toptan, ortaklık tedarik sistemini satın almış ve sektörde üye marketlerin tedarikini üstlenen öncü ve tek şirket haline gelmiştir. Yıldız Holding ile güçlü bir ortaklık yapısına sahiptir. 2011 yılında halka açılmış ve hisseleri Borsa İstanbul'da işlem görmeye başlamıştır. Şirket, nakit üreten büyüme stratejisi izlemekte ve ülke genelinde varlığını sürekli genişletmektedir.`,
   ...
   boycottReason: `Bizim Toptan, Yıldız Holding (Ülker Grubu) tarafından kontrol edilmektedir. Şirketin %66,59'u doğrudan Yıldız Holding'e aittir ve bu güçlü ortaklık yapısıyla holding bünyesinin en önemli şirketlerinden biri konumundadır.

Yıldız Holding'in, İsrail yanlısı tutum sergileyen Starbucks ile sürdürdüğü ticari işbirliği, toplumsal boykot hareketinin odak noktalarından biridir. Ülker Grubu sahibi Yahya Ülker'in boykot sürecinde Starbucks'ı ziyaret etmesi ve grup bünyesindeki marketlerde (özellikle ŞOK'ta) Starbucks ürünlerine özel raflar ayrılarak satışının sürdürülmesi, kamuoyunda büyük tepki çekmiştir.

Hassas tüketiciler, Filistin meselesinde sessiz kalan ve İsrail yanlısı politikalar izlediği düşünülen Starbucks ile ticari bağlarını sürdüren şirketlerin boykot edilmesi gerektiğini savunmaktadır. Yıldız Holding bu eleştirilere rağmen söz konusu ticari ilişkisini devam ettirmektedir.

Bu nedenlerle, Yıldız Holding bünyesinde bulunan ve grubun en büyük toptan ticaret şirketi olan Bizim Toptan, boykot listesi kriterlerine göre önerilmiyor kategorisindedir.`,
  },
  {
   name: "Seç Market",
   slug: "sec-market",
   foundedYear: 2014,
   founder: "Bizim Toptan ve Yıldız Holding",
...
Şirket, mahalle marketi konseptiyle Türkiye genelinde yaygın bir ağa sahiptir ve müşterilere yakın çevrelerinde kolay erişilebilir alışveriş imkanı sunmaktadır.`,
   boycottReason: `Seç Market, 2014 yılında Bizim Toptan (%90) ve Yıldız Holding (%10) ortaklığıyla kurulmuş bir market zinciridir. Dolaylı yoldan da olsa Yıldız Holding (Ülker Grubu) bünyesinde faaliyet gösteren bir şirkettir, çünkü Bizim Toptan'ın da %66,59'u Yıldız Holding'e aittir.

Yıldız Holding'in, Filistin meselesinde İsrail yanlısı tutum sergileyen Starbucks ile süregelen ticari ilişkisi, hassas tüketiciler tarafından eleştirilmektedir. Ülker Grubu sahibi Yahya Ülker'in boykot sürecinde Starbucks'ı ziyaret etmesi ve grup bünyesindeki marketlerde Starbucks ürünlerinin satışına devam edilmesi, toplumsal tepki çekmiştir.

Birçok tüketici, İsrail yanlısı politikaları desteklediği düşünülen Starbucks ile ticari bağları sürdüren firmaların boykot edilmesi gerektiğini savunmaktadır. Seç Market, hem doğrudan Yıldız Holding ortaklığı hem de ana ortağı Bizim Toptan üzerinden dolaylı olarak Yıldız Holding bünyesinde olduğundan, boykot listesi kriterlerine göre önerilmiyor kategorisindedir.`,
  },
  {
   name: "Bim",
   slug: "bim",
   foundedYear: 1995,
   founder: "Cüneyd Zapsu, Aziz Zapsu, Yasin El Kadı, Korkut Özal, Mustafa Latif Topbaş ve Mehmet Fatih Saraç",
   owner:
    "Halka açık (%71,4) ve Merkez Bereket Gıda A.Ş. (%15,3) ve Naspak Gıda A.Ş. (%11,6) ve Halka Kapalı (%1,5)",
   country: "Türkiye",
   alternative_products: [
    "tarim-kredi-kooperatif-marketleri",
    "cagri",
   ...
   description: `Birleşik Mağazalar A.Ş. (BİM), 1995 yılında 21 mağaza ile başladığı yolculuğunda, benimsediği "yüksek indirim" (hard-discount) modeliyle bugün Türkiye perakende sektörünün lideri konumuna yükselmiştir. Merkezi İstanbul Sancaktepe’de bulunan ve 2005 yılından beri Borsa İstanbul’da işlem gören şirket, şeffaf yönetim anlayışı ve %71'i aşan halka açıklık oranıyla Türkiye'nin en önemli ticari değerlerinden biridir. Temel gıda ve tüketim malzemelerini yüksek kalite ve en uygun fiyatla tüketiciye ulaştırmayı ilke edinen BİM, maliyet odaklı operasyon yapısıyla enflasyonla mücadelede de stratejik bir rol oynamaktadır.

Operasyonel gücünü sürekli artıran BİM, Haziran 2025 verilerine göre Türkiye, Fas ve Mısır’da toplam 14.075 mağazaya ve 100 bini aşkın çalışana ulaşmıştır. Sadece indirim marketçiliğiyle sınırlı kalmayan şirket; süpermarket formatındaki FİLE, et sektöründeki Aytaç ve telekomünikasyon alanındaki BİMcell gibi iştirakleriyle geniş bir hizmet ekosistemi kurmuştur. Özellikle FİLE mağazalarıyla farklı bir segmentte de büyüyen marka, kendi öz markalı (private label) ürünlerine verdiği ağırlıkla yerli üretimi ve tedarikçileri güçlü bir şekilde desteklemektedir.
   
BİM, %100 yerli sermaye yapısına sahip bir Türk şirketi olmasına rağmen, raflarında global markalı ürünlerin satışına yer vermesi nedeniyle zaman zaman yanlış anlaşılmalara konu olabilmektedir. Ancak perakende sektörünün doğası gereği yapılan bu ürün çeşitliliği, markanın aidiyetini değiştirmemektedir. BİM, hem sermaye yapısı hem de yönetim kadrosuyla yerli bir marka olup, herhangi bir boykot listesinde yer almamaktadır; aksine yerel ekonominin en güçlü zincirlerinden biri olarak faaliyetlerini sürdürmektedir.   
`,
  },
  {
   name: "File",
...
2021 yılında şirket "File Market" adlı bir market teslimat uygulaması geliştirmiştir. Nisan 2021 itibarıyla şirketin Türkiye'de 135 şubesi ve yaklaşık 4.000 çalışanı bulunmaktadır.`,
  },
  {
   ...
   description: `A101 Yeni Mağazacılık A.Ş., 28 Mart 2008 tarihinde kurulan ve kısa sürede Türkiye'nin en yaygın perakende zincirlerinden biri haline gelen yerli bir markadır. İstanbul Üsküdar merkezli şirket, Turgut Aydın Holding bünyesindeki Aydın Ailesi'nin %79,21'lik sahiplik oranıyla yönetilmektedir. 2023 sonu itibarıyla 81 il ve 923 ilçede 13.000’i aşkın mağaza sayısına ulaşan A101, Türkiye'nin en büyük istihdam sağlayan kuruluşları arasında yer almaktadır.

"Hard discount" (yüksek indirim) konseptiyle faaliyet gösteren şirket, düşük maliyetli ve kaliteli gıda ile tüketim malzemelerini tüketicilere sunmayı hedefler. Geleneksel mağazacılığın yanı sıra dijitalleşmeye de önem veren A101, e-ticaret platformları aracılığıyla da hizmet vererek hem online hem de fiziksel mağazacılık deneyimini bir arada sunmaktadır.

A101, tamamen yerli sermaye yapısına sahip bir Türk şirketi olup, Turgut Aydın Holding çatısı altında faaliyetlerine devam etmektedir. Bazı sosyal medya paylaşımlarında markanın adı boykot kapsamında geçse de, şirketin sermaye yapısı veya ticari duruşuyla ilgili bunun geçerli bir dayanağı bulunmamaktadır. Raflarında global markalı ürünlerin satışa sunulması perakende sektörünün genel işleyişinden kaynaklanmakta olup, bu durum şirketin yerli kimliğini değiştirmemektedir.`,
  },
  {
   name: "Migros",
   slug: "migros",
   foundedYear: 1954,
   founder: "İstanbul Belediyesi ve İsviçre Migros Kooperatifi",
   owner: "Anadolu Grubu",
   country: "Türkiye",
   alternative_products: [
    "tarim-kredi-kooperatif-marketleri",
   ...
   description: `Migros Ticaret A.Ş., temelleri 1954 yılında İstanbul Belediyesi ve İsviçre Migros Kooperatifi iş birliğiyle atılan, Türkiye’nin en köklü ve öncü perakende zinciridir. "Ucuzluğun Kralı" sloganıyla ve seyyar satış kamyonlarıyla başlayan yolculuğu, zaman içinde Koç Holding ve ardından Anadolu Grubu bünyesine geçerek dev bir perakende ekosistemine dönüşmüştür. Günümüzde 81 ilde; M, MM, MMM, 5M ve Migros Jet gibi farklı formatlardaki binlerce mağazasıyla hizmet veren şirket, sektörün amiral gemisi konumundadır.
   
Sadece süpermarketçilikle sınırlı kalmayan Migros; Macrocenter, Mion ve Tazedirekt gibi özelleşmiş alt markalarıyla farklı müşteri segmentlerine hitap etmektedir. 2025 verilerine göre 3.700’den fazla mağazaya ve devasa bir lojistik ağına sahip olan marka, aynı zamanda Migros Sanal Market ve Migros Hemen gibi girişimleriyle online marketçiliğin de Türkiye’deki kurucusu ve lideridir.

Şirketin yönetim yapısı 2015 yılından bu yana, Türkiye’nin en büyük holdinglerinden biri olan Anadolu Grubu’na aittir. Teknoloji odaklı perakendecilik anlayışı, Money sadakat programı ve sürdürülebilirlik çalışmalarıyla bilinen Migros, yıllık 293 milyar TL'yi aşan gelir hacmiyle (2024 verisi) Türkiye ekonomisinin en büyük ticari güçlerinden biri olarak faaliyetlerine devam etmektedir.`,
   boycottReason: `Migros'un boykot listesinde yer almasının iki temel nedeni bulunmaktadır. Birincisi ve en güçlü ticari neden; şirketin sahibi olan Anadolu Grubu'nun, aynı zamanda Coca-Cola İçecek A.Ş.'nin ana hissedarı ve Türkiye'deki tek yetkili üreticisi olmasıdır.

İkinci neden ise İsviçre Migros kaynaklı krizdir. Her ne kadar şirketler ayrılmış olsa da isim benzerliği tepkileri beraberinde getirmiştir. İsviçre Migros, piyanist Fazıl Say'ın İsrail'in Gazze politikalarına yönelik eleştirileri ve Cumhurbaşkanı Recep Tayyip Erdoğan'ın duruşuna verdiği destek nedeniyle sanatçının konserlerini iptal etmiştir. Bu sansür girişimi Türk kamuoyunda büyük tepki çekmiş ve tepkiler Türkiye'deki Migros'a da boykot çağrısı olarak yansımıştır.`,
  },
  {
   name: "Macrocenter",
   slug: "macrocenter",
...
Migros'un boykot listesinde yer almasının iki temel nedeni bulunmaktadır. Birincisi ve en güçlü ticari neden; şirketin sahibi olan Anadolu Grubu'nun, aynı zamanda Coca-Cola İçecek A.Ş.'nin ana hissedarı ve Türkiye'deki tek yetkili üreticisi olmasıdır.

İkinci neden ise İsviçre Migros kaynaklı krizdir. Her ne kadar şirketler ayrılmış olsa da isim benzerliği tepkileri beraberinde getirmiştir. İsviçre Migros, piyanist Fazıl Say'ın İsrail'in Gazze politikalarına yönelik eleştirileri ve Cumhurbaşkanı Recep Tayyip Erdoğan'ın duruşuna verdiği destek nedeniyle sanatçının konserlerini iptal etmiştir. Bu sansür girişimi Türk kamuoyunda büyük tepki çekmiş ve tepkiler Türkiye'deki Migros'a da boykot çağrısı olarak yansımıştır.

Macrocenter'ın Migros'a bağlı olması ve Migros markası altında faaliyet göstermesi nedeniyle, Migros'un boykot edilmesi Macrocenter'ı da kapsamaktadır. Bu nedenle Macrocenter markası boykot listelerine dahil edilmiştir.`,
  },
  {
   name: "Kipa",
   slug: "kipa",
...
Türkiye'deki bir tüketiciye sunulan hizmette, herhangi bir hukuki anlaşmazlık için İsrail yasalarının ve Tel Aviv mahkemelerinin yetkili kılınması, kamuoyunda büyük tepkiye yol açmış ve markanın boykot edilmesi için yapılan çağrıların ana nedenini oluşturmuştur.`,
   evidences: ["https://www.tuketicipostasi.com/tuketici-birligi-federasyonu-israil-mahkemelerini-halkimiza-dayatan-metro-grosmarket/8233/"],
  },
  {
