...
Clear, kepek önleme ve saç bakımı alanında faaliyet göstermektedir ve Unilever'in kişisel bakım markalarından biridir.`,
  },
  {
   ...
   website: "https://kurumsal.sokmarket.com.tr/markalar/soka-ozel-urunler/mon-amour",
   description: `Mon Amour, Şok Marketler zincirinin renkli kozmetik ve kişisel bakım kategorisindeki tescilli markasıdır. Uygun fiyatlı makyaj ürünleri, oje, aseton, parfüm ve deodorant gibi geniş bir ürün yelpazesi sunarak güzelliği herkes için ulaşılabilir kılmayı hedefler. Trendleri takip eden renk seçenekleri ve pratik ambalajlarıyla özellikle genç tüketicilerin ilgisini çeken bir markadır.`,
   boycottReason: `Mon Amour, Şok Marketler'in özel markasıdır ve dolayısıyla Yıldız Holding şemsiyesi altındadır. Holding, yerli bir sermaye grubu olmasına rağmen, global pazardaki büyüme stratejileri kapsamında kurduğu bazı uluslararası ortaklıklar ve sermaye hareketleri nedeniyle kamuoyunda tartışmalara konu olmaktadır.
...
Özellikle Yıldız Holding'in, küresel boykot listelerinde yer alan bazı markalarla (örneğin Starbucks) olan dolaylı ticari bağları ve yatırımları, hassasiyet sahibi tüketiciler tarafından eleştirilmektedir. Bu ticari ilişkiler ağı nedeniyle marka, tam kapsamlı bir boykot listesinde yer almasa da, alternatiflerin değerlendirilmesi adına 'önerilmeyen' statüsünde sınıflandırılmaktadır.`,
  ...
  },
  {
   ...
   img: "/adam.png",
   isBoycotted: "onerilmiyor",
   website: "https://kurumsal.sokmarket.com.tr/markalar/soka-ozel-urunler/adam",
   description: `ADAM, Şok Marketler tarafından erkek bakım ihtiyaçlarına yönelik geliştirilmiş özel bir markadır. Tıraş bıçakları, tıraş köpükleri, deodorantlar ve duş jelleri gibi ürünlerle erkeklerin günlük kişisel bakım rutinlerini ekonomik ve kaliteli bir şekilde karşılamayı amaçlar. "Bakımlı erkeğin tercihi" olma iddiasıyla raflarda yerini almaktadır.`,
   boycottReason: `ADAM, Şok Marketler'in özel markasıdır ve dolayısıyla Yıldız Holding şemsiyesi altındadır. Holding, yerli bir sermaye grubu olmasına rağmen, global pazardaki büyüme stratejileri kapsamında kurduğu bazı uluslararası ortaklıklar ve sermaye hareketleri nedeniyle kamuoyunda tartışmalara konu olmaktadır.
...
Özellikle Yıldız Holding'in, küresel boykot listelerinde yer alan bazı markalarla (örneğin Starbucks) olan dolaylı ticari bağları ve yatırımları, hassasiyet sahibi tüketiciler tarafından eleştirilmektedir. Bu ticari ilişkiler ağı nedeniyle marka, tam kapsamlı bir boykot listesinde yer almasa da, alternatiflerin değerlendirilmesi adına 'önerilmeyen' statüsünde sınıflandırılmaktadır.`,
  ...
  },
  {
   ...
   country: "ABD",
   alternative_products: ["difas", "misswell", "eyup-sabri-tuncer", "agarta"],
   img: "/colgate.png",
   isBoycotted: "boykot",
   website: "https://www.colgate.com/tr-tr",
   description: `Colgate, temelleri 1806 yılında William Colgate tarafından atılan, ancak asıl ününü 1873 yılında kavanozlarda satılan aromatik diş macununu piyasaya sürmesiyle kazanan, dünyanın en köklü ağız bakım markasıdır. 1896 yılında katlanabilir tüp ambalajına geçerek sektörde devrim yaratan marka, o günden beri diş macunu, diş fırçası, ağız bakım suyu ve diş ipi gibi ürünlerle global pazarın lideridir.

1928 yılında Palmolive şirketi ile birleşerek "Colgate-Palmolive" adını alan şirket, sadece ürün satmakla kalmamış, 1911 yılından itibaren okullarda ücretsiz diş fırçası dağıtarak ve hijyen eğitimi vererek küresel ağız sağlığı bilincinin oluşmasına öncülük etmiştir. Bugün 200'den fazla ülkede faaliyet gösteren marka, "Gülümseyin, güç sizde" sloganıyla tanınmaktadır.`,
   boycottReason: `Colgate, Amerika Birleşik Devletleri merkezli Colgate-Palmolive şirketine ait bir markadır. ABD'nin İsrail'e yönelik koşulsuz siyasi ve askeri desteği nedeniyle, Amerikan ekonomisine vergi veren ve katkı sağlayan bu dev şirket boykot listesinde yer almaktadır. Ayrıca şirketin İsrail'deki üretim ve ticari faaliyetleri de boykot çağrılarının temel nedenlerinden biridir.`,
   evidences: [""],
  },
  {
   name: "Difaş",
   ...
   country: "Türkiye",
   alternative_products: ["misswell", "eyup-sabri-tuncer", "agarta"],
   img: "/difas.png",
   isBoycotted: "boykot-degil",
   website: "https://www.difas.com.tr/tr",
   description: `Difaş, 1966 yılında başladığı üretim yolculuğunda bugün Türkiye'nin önde gelen diş fırçası markalarından biri haline gelmiş köklü bir kuruluştur. Yarım asrı aşkın tecrübesiyle sadece ağız bakımıyla sınırlı kalmayıp; kişisel bakım ve ev bakım fırçalarıyla da ürün yelpazesini genişletmiş ve müşteri ihtiyaçlarına kapsamlı çözümler sunmuştur.

Dünyanın sayılı üretici ve satıcı firmaları arasında yer alan Difaş, perakende mağazalar zincirlerine yaptığı "Private Label" (özel markalı) üretimlerle de sektörde tercih edilen bir iş ortağıdır. Sürekli yatırımlarla kapasitesini artıran şirket, birçok ülkeye ihracat yaparak Türk kalitesini uluslararası pazarlara taşımaktadır.

Kurumsal yapısını TSE, ISO 9001 Kalite Yönetim Sistemi gibi belgelerle güçlendiren firma; uluslararası geçerliliği olan, yetkilendirilmiş ve akredite belgelendirme kuruluşları tarafından onaylanmış kalite standartlarına sahiptir. İnsana ve çevreye saygılı, yenilikçi ve müşteri odaklı üretim anlayışıyla faaliyetlerini sürdürmektedir.`,
  },
  {
   name: "Misswell",
   slug: "misswell",
...
Misswell, boykot dışıdır. Yerli üretime odaklanan platform, Türkiye'nin yerli girişimcilerini desteklemekte ve İsrail bağlantısı bulunmamaktadır. Marka, yerli üretimin gelişmesine katkıda bulunmakta ve Türkiye'nin ekonomik bağımsızlığına destek sağlamaktadır.`,
   ...
   img: "/misswell.png",
   isBoycotted: "boykot-degil",
   alternative_products: ["difas", "eyup-sabri-tuncer", "agarta"],
  },
  {
   ...
   country: "Türkiye",
   alternative_products: ["agarta", "difas", "misswell"],
   img: "/eyup-sabri-tuncer.png",
   isBoycotted: "boykot-degil",
   website: "https://www.eyupsabrituncer.com/",
   description: `Altınkılıç, temelleri 1957 yılında Mehmet Altınkılıç'ın İstanbul'a gelmesiyle atılan, 1976 yılında Unkapanı'nda ticari faaliyetine resmen başlayan köklü bir süt ürünleri markasıdır. 1991 yılında markalaşma sürecini tamamlayan şirket, Türkiye'nin en verimli süt bölgelerinden biri olan Ezine'de kurduğu 20.000 metrekarelik tesislerinde üretim yaparak geleneksel peynir lezzetlerini standart kaliteyle sunmayı başarmıştır.

   Markanın oldukça geniş olan ürün portföyü, özellikle yöresel lezzetlere odaklanmıştır. Balıkesir Karaağaç tesislerinde özel olarak üretilen "İdamonte" serisi Tam Yağlı Olgunlaştırılmış Eski Kaşar, markanın amiral gemisidir. Bunun yanı sıra Ezine Peyniri, İzmir Tulumu, Örgü, Dil, Çeçil ve Lor peyniri gibi çeşitleriyle kahvaltı sofralarının vazgeçilmezidir.
   
   Geleneksel peynirciliğin yanı sıra inovasyona da büyük önem veren Altınkılıç, 2001 yılından itibaren Ege Üniversitesi ile yürüttüğü Ar-Ge çalışmaları sonucu Türkiye'de "Kefir" üretiminin öncülerinden biri olmuştur. Doğallık ve sağlık vizyonuyla hareket eden marka, %100 yerli sermaye ile faaliyetlerine devam etmektedir.`,
  },
  /*   {
     name: "Agarta",
     slug: "agarta",
     ...
     owner: "",
     country: "",
     alternative_products: ["eyup-sabri-tuncer", "difas", "misswell"],
     img: "/.png",
     isBoycotted: "boykot",
     website: "https://agartakozmetik.com.tr/",
     description: ``,
     boycottReason: ``,
     evidences: [""],
    }, */
